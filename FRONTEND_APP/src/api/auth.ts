...
export const authApi = {
    ...
    updateNiche: (nicheDescription: string) => client.post('/auth/niche', { nicheDescription }),
    updatePostingTime: (postingTime: string) => client.post('/auth/posting-time', { postingTime }),
